...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2020 at 06:10 AM
...
--
-- RELATIONSHIPS FOR TABLE `budget_invoices`:
--   `fund_id`
--       `fund` -> `fund_id`
--   `inv_id`
--       `invoices` -> `inv_id`
...
--
-- RELATIONSHIPS FOR TABLE `domains`:
--
...
--
-- RELATIONSHIPS FOR TABLE `function_menu`:
--   `fmenu_parid`
--       `function_menu` -> `fmenu_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `fund_invoices`:
--   `fund_from`
--       `fund` -> `fund_id`
--   `fund_to`
--       `fund` -> `fund_id`
...
--
-- RELATIONSHIPS FOR TABLE `fund_type`:
--
...
--
-- RELATIONSHIPS FOR TABLE `imo_details`:
--   `msp_id`
--       `mat_split` -> `msp_id`
--   `imo_id`
--       `instock_modify` -> `imo_id`
--   `smm_id`
--       `stock_mat_msu` -> `smm_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `instock_modify`:
--   `user_id`
--       `users` -> `user_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `login_history`:
--
...
--
-- RELATIONSHIPS FOR TABLE `manufactures`:
--
...
--
-- RELATIONSHIPS FOR TABLE `mat_move_invoices`:
--   `user_id`
--       `users` -> `user_id`
--   `created_user`
--       `users` -> `user_id`
...
--
-- RELATIONSHIPS FOR TABLE `mat_move_invoice_details`:
--   `inv_id`
--       `mat_move_invoices` -> `inv_id`
--   `smm_id`
--       `stock_mat_msu` -> `smm_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `mat_msu`:
--   `mat_id`
--       `materials` -> `mat_id`
--   `msu_id`
--       `meansure` -> `msu_id`
...
--
-- RELATIONSHIPS FOR TABLE `mat_return_invoices`:
--   `cus_id`
--       `customers` -> `cus_id`
--   `stock_id`
--       `stocks` -> `stock_id`
...
--
-- RELATIONSHIPS FOR TABLE `mat_return_invoice_details`:
--   `inv_id`
--       `mat_return_invoices` -> `inv_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `mat_split`:
--   `smm_id`
--       `stock_mat_msu` -> `smm_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `mat_split_history`:
--
...
--
-- RELATIONSHIPS FOR TABLE `mat_split_history_details`:
--
...
--
-- RELATIONSHIPS FOR TABLE `meansure`:
--   `msu_parid`
--       `meansure` -> `msu_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `mfa_mat`:
--   `mat_id`
--       `materials` -> `mat_id`
--   `mfa_id`
--       `manufactures` -> `mfa_id`
...
--
-- RELATIONSHIPS FOR TABLE `nhomhopdong`:
--
...
--
-- RELATIONSHIPS FOR TABLE `out_invoices`:
--   `user_id`
--       `users` -> `user_id`
--   `created_user`
--       `users` -> `user_id`
...
--
-- RELATIONSHIPS FOR TABLE `out_invoice_details`:
--   `inv_id`
--       `out_invoices` -> `inv_id`
--   `smm_id`
--       `stock_mat_msu` -> `smm_id`
...
--
-- RELATIONSHIPS FOR TABLE `out_serials`:
--   `invd_id`
--       `out_invoice_details` -> `invd_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `phuphi`:
--
...
--
-- RELATIONSHIPS FOR TABLE `serials`:
--   `mms_id`
--       `mat_msu` -> `mms_id`
--   `smm_id`
--       `stock_mat_msu` -> `smm_id`
...
--
-- RELATIONSHIPS FOR TABLE `stock_mat_msu`:
--   `mms_id`
--       `mat_msu` -> `mms_id`
--   `stock_id`
--       `stocks` -> `stock_id`
...
--
-- RELATIONSHIPS FOR TABLE `sup_mat`:
--   `mat_id`
--       `materials` -> `mat_id`
--   `sup_id`
--       `supliers` -> `sup_id`
...
--
-- RELATIONSHIPS FOR TABLE `user_group_permission`:
--   `group_id`
--       `groups` -> `group_id`
--   `user_id`
--       `users` -> `user_id`
...
--
-- RELATIONSHIPS FOR TABLE `waranty_dept`:
--
...
--
-- RELATIONSHIPS FOR TABLE `waranty_invoices`:
--
...
--
-- RELATIONSHIPS FOR TABLE `waranty_invoice_details`:
--   `oinvd_id`
--       `out_invoice_details` -> `invd_id`
--   `inv_id`
--       `waranty_invoices` -> `inv_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `waranty_materials`:
--   `invd_id`
--       `waranty_invoice_details` -> `invd_id`
--   `mat_id`
--       `materials` -> `mat_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `waranty_services`:
--   `invd_id`
--       `waranty_invoice_details` -> `invd_id`
--
