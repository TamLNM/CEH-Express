...
<div class="mtop40">
   <div class="col-md-4 col-md-offset-4 text-center">
      <h1 class="text-uppercase mbot20 login-heading" hidden>
         <?php
   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
      ...
      <div class="panel_s">
         <div class="panel-body">
            ...
            <?php } ?>
            <div class="checkbox" style="float: left; margin-top: 0!important">
            ...
            <a style="float: right;" href="<?php echo site_url('authentication/forgot_password'); ?>"><?php echo _l('customer_forgot_password'); ?></a>
