...
class excel_export {
    ...
    function output_inv() {
        ...
        for ($i = 0; $i < count($mat); $i++) {         
            ...
            if(empty($_GET['chkprice'])) {
                ...
                $objPHPExcel->getActiveSheet()->getStyle('G' . ($i + 28))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('H' . ($i + 28))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('I' . ($i + 28))->getNumberFormat()->setFormatCode('#,###.##');
                $total+=$mat[$i]['amount'];                
            } else {
                $objPHPExcel->getActiveSheet()->mergeCells('F' . ($i + 28) . ':I' . ($i + 28));
            }

            $objPHPExcel->getActiveSheet()->getStyle('E' . ($i + 28))->getNumberFormat()->setFormatCode('#,###.##');
        }
        if(empty($_GET['chkprice'])) {
            ...
            $objPHPExcel->getActiveSheet()->getStyle('I' . (28 + count($mat)))->getNumberFormat()->setFormatCode('#,###.##');
    ...
    function output() {
        ...
        $inv = get_data("select cat.cat_name, inv.inv_id, msu.msu_name, inv.inv_code, inv.created_date, inv.cus_id, usr.full_name, mat.mat_name, cus.cus_name,  invd.amount, invd.mat_quantity 
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('D12', 'Người bán');
        $objPHPExcel->getActiveSheet()->setCellValue('E12', 'Khách hàng');
        ...
        for ($i = 0; $i < count($inv); $i++) {
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 13), $inv[$i]['cus_name']);
            ...
            $objPHPExcel->getActiveSheet()->getStyle('H' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('J' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('K' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
        ...
        $objPHPExcel->getActiveSheet()->getStyle('K' . (13 + count($inv)))->getNumberFormat()->setFormatCode('#,###.##');
    ...
    function instock() {
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A12:K13')->applyFromArray(
                array(
                    'font' => array(
                        'bold' => true
                    ),
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A12:K' . (13 + count($mat)))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('A12:K' . (13 + count($mat)))->getAlignment()->setWrapText(true);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A12:K' . (14 + count($mat)))->applyFromArray(
                array(
                    'font' => array(
                        'size' => 10
                    ),
        ...
        for ($j = 0; $j < count($mat); $j++) {
            $q = $sell->get_instock($mat[$i], $edate, $_GET['stock_id']);
            $mat_instock = $q['sum'];
            ...
            if ((round($mat_quantity) > 0 && @$return_val['mat_status'] == 'con') || ($return_val['mat_status'] == 'het' && round($mat_quantity) == 0) || $return_val['mat_status'] == '') {
                ...
                $objPHPExcel->getActiveSheet()->getStyle('E' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('F' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('G' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('H' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('I' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $objPHPExcel->getActiveSheet()->getStyle('K' . ($i + 14))->getNumberFormat()->setFormatCode('#,###.##');
                $i++;
            }
        }
        $objPHPExcel->getActiveSheet()->mergeCells('A' . (14 + count($mat)) . ':J' . ($i + 14));
        ...
        $objPHPExcel->getActiveSheet()->getStyle('K' . (14 + count($mat)))->getNumberFormat()->setFormatCode('#,###.##');
    ...
    function mat_move() {
        ...
        for ($i = 0; $i < count($inv); $i++) {
            ...
            $objPHPExcel->getActiveSheet()->getStyle('I' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('C' . ($i + 13))->getNumberFormat()->setFormatCode('DD/MM/YY HH:MM');
        }
    ...
    function mat_return() {
        ...
        for ($i = 0; $i < count($inv); $i++) {
            ...
            $objPHPExcel->getActiveSheet()->getStyle('I' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('K' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('L' . ($i + 13))->getNumberFormat()->setFormatCode('#,###.##');
            $objPHPExcel->getActiveSheet()->getStyle('C' . ($i + 13))->getNumberFormat()->setFormatCode('DD/MM/YY HH:MM');
            $total+=$inv[$i]['amount'];
        }
        ...
        $objPHPExcel->getActiveSheet()->getStyle('L' . (13 + count($inv)))->getNumberFormat()->setFormatCode('#,###.##');
        $objPHPExcel->getActiveSheet()->getStyle('A' . (13 + count($inv)))->getFont()->setBold(true);
