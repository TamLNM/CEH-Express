$(document).ready(function () {
	...
	//--------------------------------------------------------------------------------------
        ...
        $(document).on("mouseenter","#contenttable tr td:nth-child(4)",function(e){
        	$(".vk_findaq").remove();
        	$(this).append("<div class='vk_findaq'></div>");
        });
        $(document).on("mouseleave","#contenttable tr td:nth-child(4)",function(e){
        	$(".vk_findaq").remove();
        });
        $(document).on("click","#contenttable tr td:nth-child(4)",function(e){
        	datacall=this;
        	var tablek=ajd2;
        	$("#search-ship-name").val("");
        	$("#groups-modalLabel").attr("xtable",tablek);
        	$("#groups-modalLabel").html("Chọn công ty");
        	$(".modal").show();
